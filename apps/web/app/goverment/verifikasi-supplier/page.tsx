    ...
    <div className="w-full min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-5 shadow-2xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {/* Quick Stat Pill */}
          <div className="flex items-center gap-3 bg-slate-100 p-2 rounded-2xl border border-slate-200/80">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-xl shadow-2xs border border-slate-200/60">
              <Cpu className="w-4 h-4 text-emerald-600 animate-pulse" />
              <div className="text-left">
                <p className="text-[9px] font-black uppercase text-slate-400">Status Engine AI</p>
                <p className="text-xs font-black text-slate-800">ONLINE (98.8% Acc)</p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-xl shadow-2xs border border-slate-200/60">
              <Fingerprint className="w-4 h-4 text-primary" />
              <div className="text-left">
                <p className="text-[9px] font-black uppercase text-slate-400">SBT Whitelisted</p>
                <p className="text-xs font-black text-slate-800">{suppliers.filter(s => s.sbtStatus === "WHITELISTED").length} / {suppliers.length} Vendor</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4">
        <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3.5">
          <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Total Supplier</p>
              <p className="text-lg font-black text-slate-900">{stats.totalSuppliers} <span className="text-xs font-semibold text-slate-500">Badan Usaha</span></p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Akurasi AI OCR</p>
              <p className="text-lg font-black text-emerald-700">{stats.avgAccuracy}% <span className="text-xs font-bold text-emerald-600">Optimal</span></p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Dokumen Sah</p>
              <p className="text-lg font-black text-slate-900">{stats.verifiedDocs} <span className="text-xs font-semibold text-slate-500">Berkas</span></p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Perlu Review / Revisi</p>
              <p className="text-lg font-black text-amber-700">{stats.pendingDocs} <span className="text-xs font-semibold text-amber-600">Dokumen</span></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto w-full p-6 flex-1 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-2xs flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex items-center gap-2 overflow-x-auto pb-2 lg:pb-0">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap mr-1">Pilih Supplier:</span>
            {suppliers.map((sup) => {
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Button
              ...
              disabled={isScanning}
              size="sm"
              className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl h-9 gap-2 cursor-pointer shadow-sm shadow-emerald-600/20"
            >
              {isScanning ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : <UploadCloud className="w-3.5 h-3.5" />}
              {isScanning ? "Memindai AI..." : "Simulasi Upload & Scan Dokumen"}
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
              <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-xs uppercase tracking-wider text-slate-700">Canvas AI OCR & Pratinjau Visual</span>
                </div>
                <Badge className="bg-slate-200 text-slate-800 text-[10px] font-mono">
                  {currentDoc.ocrConfidence}% Confidence
                </Badge>
              </div>

              {/* Document Interactive Preview Frame */}
              <div className="p-5 bg-slate-900 text-white relative flex flex-col items-center justify-center min-h-[280px] overflow-hidden">
                ...
                {/* Document Mock Sheet */}
                <div className="w-full max-w-sm bg-white text-slate-900 rounded-xl p-4 shadow-xl border border-slate-200/40 relative font-mono text-[11px] leading-relaxed">
                  ...
                  <div className="space-y-2">
                    <div className="p-1.5 rounded bg-emerald-50 border border-emerald-300 relative group">
                      ...
                      <p className="font-bold text-slate-900 text-xs mt-0.5">{currentSupplier.nama}</p>
                    </div>
                    ...
                    <div className="p-1.5 rounded bg-blue-50 border border-blue-300 relative">
                      ...
                      <p className="font-bold text-blue-900 text-xs mt-0.5">{currentDoc.nomor}</p>
                    </div>

                    <div className="p-1.5 rounded bg-slate-100 border border-slate-200 text-[10px] text-slate-600">
                      <p className="font-sans">Penanggung Jawab: <span className="font-bold text-slate-800">{currentSupplier.picNama}</span></p>
                      <p className="font-sans text-[9px] text-slate-500 mt-0.5">Wilayah Operasional: {currentSupplier.wilayah}</p>
                    </div>
                  </div>

                  {/* Stamp Verification Badge */}
                  <div className="mt-3 pt-2 border-t border-slate-100 flex items-center justify-between text-[9px]">
                    <span className="text-slate-400">Verifikasi Visual AI:</span>
              ...
              <div className="p-5 bg-white border-t border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-700">Status Soulbound Token (SBT)</span>
                  </div>
                  <Badge
                    className={
                ...
                >
                  ...
                  {currentSupplier.sbtStatus === "WHITELISTED"
                    ? "Tercatat Resmi di Whitelist Ledger B.O.G.A ✓"
                    : isMinting
                    ? "Menerbitkan Token SBT..."
                    : "Otorisasi & Terbitkan SBT Whitelist ke Ledger"}
                </Button>
              </div>
            </div>
          ...
          {/* Right Column (7 Cols) — Matrix Ekstraksi & Cross-Check API */}
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-5 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="text-base font-black text-slate-900">{currentSupplier.nama}</h2>
                ...
                <div className="text-right">
                  ...
                  <span className="text-xl font-black text-emerald-600">{currentSupplier.scoreTrust} / 100</span>
                </div>
              </div>

              {/* PIC Details Grid */}
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-3.5 text-xs">
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Penanggung Jawab (PIC)</span>
                  <span className="font-bold text-slate-800">{currentSupplier.picNama}</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">NIK Terdaftar</span>
                  <span className="font-mono font-bold text-slate-800">{currentSupplier.picNik}</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Rekening Bank Terdaftar</span>
                  <span className="font-bold text-slate-800">{currentSupplier.bankName} - {currentSupplier.rekeningBank}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                ...
                <span className="text-xs text-slate-400">Pilih berkas untuk melihat detail ekstraksi</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-sm text-slate-900">{doc.labelJenis}</span>
